...
import { Shield, Zap, Globe, BarChart3, Users, Lock } from 'lucide-react'
  ...
  return (
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
             ...
             Why Choose{' '}
             <span className="text-gradient">Pay Per Lead</span>
           </h2>
           <p className="text-xl text-gray-300 max-w-3xl mx-auto">
             Our performance-based model ensures you only pay for qualified leads 
             that meet your exact criteria and conversion standards.
           </p>
        </motion.div>
